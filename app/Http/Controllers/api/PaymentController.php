...
class PaymentController extends Controller
{
    ...
    public function payment(Request $request)
    {
        ...
        try {
            ...
            if ($booking->type == 1) {
                $data = ['title' => 'Booking Confirmation Receipt', 'type' => $booking->type, 'email' => $booking->customer_email, 'name' => $booking->customer_name ?? '', 'booking_id' => $booking->booking_id, 'booking_date' => $booking->start_date, 'booking_time' => $booking->start_time, 'dome_name' => $booking->dome_info->dome_name, 'dome_address' => $booking->dome_info->dome_address, 'field_name' => $booking->field_info->name, 'players' => $booking->players, 'paid_amount' => $booking->paid_amount, 'due_amount' => $booking->due_amount, 'total_amount' => $booking->total_amount];
            } else {
