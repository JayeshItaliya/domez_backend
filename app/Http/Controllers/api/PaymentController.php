...
class PaymentController extends Controller
{
    public function payment(Request $request)
    {
        ...
        if ($request->booking_type == 1) {
            ...
            if (Carbon::createFromFormat('Y-m-d', $request->booking_date)->isPast() && $request->booking_date != Carbon::today()->format('Y-m-d')) {
            ...
            try {
                ...
                if ($request->booking_type == 1) {
                    ...
                    $transaction->league_id = $request->league_id;
                }
                ...
                if ($request->booking_type == 1) {
                    ...
                    $booking->league_id = $request->league_id;
                }
                $booking->league_id = $request->league_id;
                ...
                $booking->due_amount = $request->total_amount - $request->paid_amount;
