...
class Helper
{
    ...
    {
        $path = url('storage/app/public/new_admin/images/' . $image);
        if(Str::contains($image , 'logo')){
            $path = url('storage/app/public/new_admin/images/' . $image);
        }
        if(Str::contains($image , 'favicon')){
            $path = url('storage/app/public/new_admin/images/favicon/' . $image);
        }
        if(Str::contains($image , 'vendor') || Str::contains($image , 'default')){
            $path = url('storage/app/public/new_admin/images/profiles/' . $image);
        }
        if(Str::contains($image , 'login') || Str::contains($image , 'register') ||
            ...
            $path = url('storage/app/public/new_admin/images/authentication/' . $image);
        }
        if(Str::contains($image , 'sport')){
            $path = url('storage/app/public/new_admin/images/sports/' . $image);
        }
        if(Str::contains($image , 'dome')){
            $path = url('storage/app/public/new_admin/images/domes/' . $image);
        }
        if(Str::contains($image , 'field')){
            $path = url('storage/app/public/new_admin/images/fields/' . $image);
        }
    ...
    public static function verificationemail($email, $name, $otp){
        $data=['title'=>'Email Verification','email'=>$email, 'name'=>$name,'otp'=>$otp,'logo'=>url('storage/app/public/new_admin/images/logo.png')];
        try {
    ...
    public static function forgotpassword($email, $name, $password){
        $data=['title'=>'Forgot Password','email'=>$email, 'name'=>$name,'password'=>$password,'logo'=>url('storage/app/public/new_admin/images/logo.png')];
        try {
