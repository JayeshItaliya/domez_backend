...
//     setTimeout(() => {
//         $('.swal2-actions').append('<button class="btn btn-outline-danger btn-sweetalert-error"> Show error </button>')
//         $('.swal2-html-container').append('<p class="text-muted my-2 d-none sweetalert-error">' +
//             responseJson.message + '</p>')
//     }, 500);
// });
// $(document).on('click', '.btn-sweetalert-error', function(e) {
//     e.preventDefault();
//     $('.sweetalert-error').toggleClass('d-none');
//     $(this).text(function(i, text){
//         return text === "Hide Error" ? "Show Error" : "Hide Error";
//     })
// });
