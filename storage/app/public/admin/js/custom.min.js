function set_cookie(t, e, o, n) {
    ...
    document.cookie = t + " = " + e + r + "; path=/", document.cookie = o + " = " + n + r + "; path=/", location.reload()
}
...
function logout(t) {
    ...
    swalWithBootstrapButtons.fire({
        ...
        showpreloader(), e.isConfirmed && (window.location = t), hidepreloader()
    })
}
...
function change_status(t, e, o) {
    ...
    swalWithBootstrapButtons.fire({
        ...
        showpreloader(), n.isConfirmed && $.ajax({
            type: "get",
            url: o,
            data: {
                id: t,
            ...
            dataType: "json",
            success: function (t) {
                1 == t ? (hidepreloader(), toastr.success("Success"), location.reload()) : (hidepreloader(), swal_cancelled(wrong))
            },
            failure: function (t) {
...
$(window).on("load", function () {
    ...
    $("form, input, textarea").attr("autocomplete", "off"), document.getElementById("bootstrapTable") && ($("#bootstrapTable").bootstrapTable({
        toolbar: ".toolbar",
        clickToSelect: !1,
        showRefresh: !1,
        search: !0,
