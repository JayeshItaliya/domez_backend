                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" required name="field[]" id="field" data-placeholder="{{ trans('labels.select') }}" multiple>
                                </select>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" required class="form-control" id="name" name="name" value="{{ old('name') }}" placeholder="{{ trans('labels.league_name') }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" required class="form-control" id="booking_deadline" name="booking_deadline" value="{{ old('booking_deadline') }}" min="{{ date('Y-m-d') }}" {{ old('booking_deadline') == '' ? 'disabled' : '' }}>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" required class="form-control" name="start_date" id="start_date" value="{{ old('start_date') }}" min="{{ date('Y-m-d') }}">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" required class="form-control" name="end_date" id="end_date" value="{{ old('end_date') }}" disabled>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" required class="form-control start time_picker" name="start_time" value="{{ old('start_time') }}" placeholder="{{ trans('labels.start_time') }}" id="start_time">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" required class="form-control end time_picker" name="end_time" value="{{ old('end_time') }}" placeholder="{{ trans('labels.end_time') }}" id="end_time">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-select" required id="from_age" name="from_age">
                                    ...
                                    @for ($i = 1; $i <= 90; $i++)
                                        <option value="{{ $i }}" {{ $i == old('from_age') ? 'selected' : '' }}>{{ $i }}</option>
                                    @endfor
                                </select>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-select" required id="to_age" name="to_age" data-to-age="{{ old('to_age') }}">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-select" required id="min_player" name="min_player">
                                    ...
                                    @for ($i = 1; $i <= 30; $i++)
                                        <option value="{{ $i }}" {{ $i == old('min_player') ? 'selected' : '' }}>{{ $i }}</option>
                                    @endfor
                                </select>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-select" required id="max_player" name="max_player" data-max-players="{{ old('max_player') }}">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-select" required name="gender" id="gender">
                                    <option value="1" {{ old('gender') == 1 ? 'selected' : '' }}> {{ trans('labels.men') }}</option>
                                    <option value="2" {{ old('gender') == 2 ? 'selected' : '' }}> {{ trans('labels.women') }}</option>
                                    <option value="3" {{ old('gender') == 3 ? 'selected' : '' }}> {{ trans('labels.mixed') }}</option>
                                </select>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-select" required id="team_limit" name="team_limit">
                                    @for ($i = 5; $i <= 20; $i++)
                                        <option value="{{ $i }}" {{ $i == old('team_limit') ? 'selected' : '' }}>{{ $i }}</option>
                                    @endfor
                                </select>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" required class="form-control" name="price" id="price" value="{{ old('price') }}" placeholder="{{ trans('labels.price_per_team') }}">
                                </div>
