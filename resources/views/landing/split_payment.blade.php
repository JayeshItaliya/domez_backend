            ...
            <div class="container">
                <div class="card">
                    <div class="card-body">
                            ...
                            <div class="col-auto">
                                <div class="px-3 py-2 d-flex justify-content-between">
                                    ...
                                    <div class="col-auto">
                                        ...
                                        @else
                                            <span class="badge rounded-pill cursor-pointer partial-pill">Partial</span>
                                        @endif
                                    </div>
                                </div>
                            </div>
                        ...
                        <h4 class="px-3">{{ $checkbooking->dome_name->name }}</h4>
                        <hr>
                        <div class="row justify-content-between">
                            <div class="col-auto">
                                <div class="px-3 py-2 d-flex justify-content-between">
                                    ...
                                    <div class="col-auto text-muted">
                                        {{ Helper::date_format($checkbooking->start_date) }}</div>
                                </div>
                            </div>
                            <div class="col-auto">
                                <div class="px-3 py-2 d-flex justify-content-between">
                                    ...
                                    <div class="col-auto text-muted">
                                        {{ Helper::time_format($checkbooking->start_time) . ' To ' . Helper::time_format($checkbooking->end_time) }}
                                    </div>
                                </div>
                            </div>
                            <div class="col-auto">
                                <div class="px-3 py-2 d-flex justify-content-between">
                                    ...
                                    <div class="col-auto text-muted">{{ $checkbooking->players }}</div>
                                </div>
                            </div>
                        </div>
                        <div class="p-3 form-group">
                            <label class="form-label">Address</label>
                            <p class="text-muted">{{ $checkbooking->dome_info->address }}</p>
                        </div>
                    </div>
                </div>
            </div>
