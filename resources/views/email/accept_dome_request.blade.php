...
<body>
    ...
    <div
        ...
        <p>Thank you for your interest in Domez. We are pleased to inform you that your application has been accepted
            and we look forward to welcoming you to Domez.</p>
        <p>We appreciate your loyalty and trust in our platform, and we remain committed to providing you with the best
            service possible. Please do not hesitate to reach out to us if you have any questions or concerns. </p>
        ...
        {{-- @if ($is_exist == 1)
            ...
            <p>We appreciate your loyalty and trust in our platform, and we remain committed to providing you with the best service possible. Please do not hesitate to reach out to us if you have any questions or concerns. </p>
        @else
